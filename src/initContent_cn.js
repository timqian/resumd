...
- 后端: Node.js; Express; AWS lambda; serverless; GraphQL; RabbitMQ
- 数据库: DynamoDB; MongoDB; Postgres; SQLite; AWS RDS; Redis
- 前端: react.js; SASS/CSS; d3.js
- 浏览器插件: react.js; SASS/CSS;
...
- [**wewe**](https://wewe.t9t.io/): Open group chat to the world
  - 40+ group chats opened
  - Frontend: React.js; backend: node.js, AWS lambda, dynamodb
- and more on my [GitHub](https://github.com/timqian)

## 工作经历

- **[t9t.io](https://t9t.io)**: Indie Hacker; (2019/05 - now)
Trying to build something people want
- **[modelo.io](https://modelo.io)**: Backend leader; (2018/05 - 2019/05)
Lead a small backend team; Maintain and write backend code using node.js, GraphQL, PostgreSQL...
- **[modelo.io](https://modelo.io)**: Backend developer; (2016/10 - 2018/05)
Maintain and write backend code using node.js, GraphQL, PostgreSQL...
...
- *Math*: **First Price** in "2012 Zhejiang Province Collegiate Advanced Mathematics Contest".
- *Physics*: **First Price** in "2013 Zhejiang Province Collegiate Physics Contest".
- *Basketball*: **Captain** of College of Science team.
